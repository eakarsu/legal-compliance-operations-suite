export const AUTH_COOKIE = 'legal_compliance_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@legal-compliance.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@legal-compliance.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@legal-compliance.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
