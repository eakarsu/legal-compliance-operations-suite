...
const features = [
  ...
  },
  {
    ...
    title: "Speaker Diarization Review",
    href: "/speaker-diarization-review",
    category: "Court Transcription Deep Workflows",
    icon: Workflow,
    summary: "Speaker labels, uncertain segments, counsel attribution, and correction status.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Speaker Diarization Review", value: "34", note: 'Active items' },
      { label: 'Exceptions', value: "4", note: 'Need review' },
      { label: 'Due Soon', value: "7", note: 'Next 14 days' },
    ],
  },
  {
    slug: "exhibit-reference-index",
    title: "Exhibit Reference Index",
    href: "/exhibit-reference-index",
    category: "Court Transcription Deep Workflows",
    icon: Workflow,
    summary: "Exhibit mentions, timestamps, descriptions, objections, and index readiness.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Exhibit Reference Index", value: "43", note: 'Active items' },
      { label: 'Exceptions', value: "5", note: 'Need review' },
      { label: 'Due Soon', value: "8", note: 'Next 14 days' },
    ],
  },
  {
    slug: "errata-correction-queue",
    title: "Errata Correction Queue",
    href: "/errata-correction-queue",
    category: "Court Transcription Deep Workflows",
    icon: Workflow,
    summary: "Requested corrections, reviewer notes, certification impact, and final transcript status.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Errata Correction Queue", value: "52", note: 'Active items' },
      { label: 'Exceptions', value: "6", note: 'Need review' },
      { label: 'Due Soon', value: "9", note: 'Next 14 days' },
    ],
  },
  {
    slug: "transcript-certification",
    title: "Transcript Certification",
    href: "/transcript-certification",
    category: "Court Transcription Deep Workflows",
    icon: Workflow,
    summary: "Certification checklist, reporter review, final formatting, and delivery evidence.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Transcript Certification", value: "61", note: 'Active items' },
...
export const featureFamilies = [
  ...
  { name: "Court Transcription Deep Workflows", features: ["Speaker Diarization Review","Exhibit Reference Index","Errata Correction Queue","Transcript Certification"] },
