...
const entitySeeds = [
  ...
  ["legal-transcripts","Legal Transcripts Records","Legal Transcripts operating queue","Open","Legal Transcripts follow-up list","Court Reporting Transcription","$0"],
  ["transcript-issue-review","Transcript Issue Review Records","Transcript Issue Review operating queue","Review","Transcript Issue Review follow-up list","Court Reporting Transcription","$0"],
  ["deposition-summary","Deposition Summary Records","Deposition Summary operating queue","Review","Deposition Summary follow-up list","Court Reporting Transcription","$0"],
  ["speaker-diarization-review","Speaker Diarization Review Records","Speaker Diarization Review operating queue","Open","Speaker Diarization Review follow-up list","Court Transcription Deep Workflows","$0"],
  ["exhibit-reference-index","Exhibit Reference Index Records","Exhibit Reference Index operating queue","Review","Exhibit Reference Index follow-up list","Court Transcription Deep Workflows","$0"],
  ["errata-correction-queue","Errata Correction Queue Records","Errata Correction Queue operating queue","Review","Errata Correction Queue follow-up list","Court Transcription Deep Workflows","$0"],
  ["transcript-certification","Transcript Certification Records","Transcript Certification operating queue","Review","Transcript Certification follow-up list","Court Transcription Deep Workflows","$0"],
