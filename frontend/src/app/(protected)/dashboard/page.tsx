...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Legal Compliance Operations Dashboard"
      subtitle="One merged legal and compliance view for matters, contracts, eDiscovery, filings, compliance, documents, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared legal and compliance jobs into one surface. Matters, contracts, regulatory controls, filings, evidence, and AI are presented as platform features.</div>
