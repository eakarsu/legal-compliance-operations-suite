...
PORT="${PORT:-3700}"
DB_NAME="${PGDATABASE:-legal_compliance_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Legal Compliance Operations Suite"
echo "======================================="
echo
...
echo "Starting legal compliance operations suite frontend on http://localhost:$PORT"
echo "Login: admin@legal-compliance.local / admin123"
